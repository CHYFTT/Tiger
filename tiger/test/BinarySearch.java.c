...
int BS_Start(struct BS * this, int sz)
{
  ...
  aux01 = (x_1=this, x_1->vptr->Init(x_1, sz));  aux02 = (x_2=this, x_2->vptr->Print(x_2));  if ((x_3=this, x_3->vptr->Search(x_3, 8)))
...
int BS_Search(struct BS * this, int num)
{
  ...
  aux01 = 0;  bs01 = 0;  right = 0;  right = ;  left = 0;  var_cont = 1;  if (right < left)
    var_cont = 0;
  else
    nt = 0;
...
int BS_Div(struct BS * this, int num)
{
  ...
  count01 = 0;  count02 = 0;  aux03 = ;  count02 = ;  return count01;
}
...
int BS_Print(struct BS * this)
{
  ...
  j = 1;  j = ;  System_out_println (99999);
  return 0;
}
int BS_Init(struct BS * this, int sz)
{
  ...
  size = sz;  number = sz;  j = 1;  k = ;  k = ;  return 0;
}
